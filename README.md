...
**Go Adwaita File Dialog Demo** is a simple Go-based demo using GTK4/Adwaita libraries ([GoTK4](https://github.com/diamondburned/gotk4)/[GoTK4-Adwaita](https://github.com/diamondburned/gotk4-adwaita)).
